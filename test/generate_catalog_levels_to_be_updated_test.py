...
import site
site.addsitedir('sam/generate_catalog_levels_to_be_updated')

from sam.generate_catalog_levels_to_be_updated.code import GenerateCatalogLevelsToBeUpdated

class GenerateCatalogLevelsToBeUpdatedTest(unittest.TestCase):
    ...
    def process_test(self):
        ...
        stacitems = ['CBERS4/AWFI/141/123/CBERS_4_AWFI_20160506_141_123_L2.json',
        ...
        for stacitem in stacitems:
            self.db_client_.put_item(TableName=self.table_name_,
                                     Item={
                                         'stacitem':{'S': stacitem},
